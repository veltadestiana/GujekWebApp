...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" charset="utf-8" src="js/table.RESTAURANT.js"></script>
  </head>
              ...
              <div class="row">
                  ...
                  <div class="dataTables">
                        ...
                        <h1 style="text-align:center">
                          Restaurant <span>Lists</span>
                        </h1>
                        <center>
                        <table cellpadding="0" cellspacing="0" border="0" class="display" id="RESTAURANT" width="100%">
                          <thead>
                            <tr>
